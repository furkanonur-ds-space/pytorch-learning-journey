# Topic: Training a Classifier (CIFAR-10)
# Source: https://docs.pytorch.org/tutorials/beginner/blitz/cifar10_tutorial.html
# Summary:
#   1. Load and normalize the CIFAR-10 dataset (RGB images).
#   2. Define a Convolutional Neural Network (Adapted for 3 color channels).
